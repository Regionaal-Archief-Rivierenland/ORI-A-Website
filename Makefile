...
MD_SRC += pages/xml-schema.md  # generated by generate-tables, so missed by *.md
MD_SRC += pages/begrippenlijsten.md  # generated by generate-tables, so missed by *.md
...
prepare-site: $(THESAURI_DST) $(TABLE_DST) $(HTML_DST) $(CSS_DST) $(MINI_DIAGRAM_DST)  $(SVG_DST) $(PNG_DST) $(JPG_DST) $(ICO_DST) $(JS_DST) $(VOORBEELDZIP) site/ORI-A.xsd $(PRESERVICAZIP) $(SITEMAP_DST) $(BEHEERPLAN_DST) site/robots.txt
