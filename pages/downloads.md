...
2. `MINEUR` wordt verhoogd wanneer functionaliteit wordt toegevoegd _zonder_ bestaande ORI-A XML onvalide te maken (ook wel "compatibele wijzigingen"). Dergelijke wijzigingen kunnen er wel voor zorgen dat XML die eerder niet voldeed aan het XML-schema, na de wijziging wél valideert.
